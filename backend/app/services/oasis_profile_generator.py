...
class OasisProfileGenerator:
    ...
    # Group/institution entity types (need representative account persona generation)
    GROUP_ENTITY_TYPES = [
...
2. persona: Detailed persona description (2000 characters of plain text), must include:
   ...
   - Positions and views (attitude toward topics, content that may provoke or move them)
...
2. persona: Detailed account profile description (2000 characters of plain text), must include:
   ...
   - Account positioning (account type, target audience, core features)
   ...
   - Institutional memory (important part of the persona, introduce this institution's connection to the event, and its existing actions and reactions in the event)
...
- Institutional account communication must match its identity positioning"""
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        # Chinese-to-English mapping (Chinese keys needed to handle Chinese LLM output)
        gender_map = {
            "\u7537": "male",       # "male" in Chinese
            "\u5973": "female",     # "female" in Chinese
            "\u673a\u6784": "other",  # "institution" in Chinese
            "\u5176\u4ed6": "other",  # "other" in Chinese
