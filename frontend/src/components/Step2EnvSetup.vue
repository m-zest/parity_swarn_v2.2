    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Leveraging context, automatically calls tools to extract entities and relations from the knowledge graph, initializes simulation agents, and assigns unique behaviors and memories based on reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently configures world time flow rate, recommendation algorithms, individual active hours, posting frequency, event triggers based on simulation requirements and reality seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Simulation environment is ready. You may start the simulation.</p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">Swarm Engine auto-plans simulating <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of reality, each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
...
.badge.success { background: rgba(34,197,94,0.1); color: #2E7D32; }
.badge.processing { background: #3b82f6; color: #FFF; }
.badge.pending { background: #161616; color: #999; }
.badge.accent { background: rgba(59,130,246,0.1); color: #1565C0; }
