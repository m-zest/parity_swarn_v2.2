...
class SimulationRunner:
    ...
    def cleanup_all_simulations(cls):
        ...
        # Check if there is content to clean up (avoid useless log printing for empty processes)
    ...
    def register_cleanup(cls):
        ...
        # WERKZEUG_RUN_MAIN=true means it is the reloader subprocess
        # If not debug mode, this env var does not exist, also need to register
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: Interview on both platforms simultaneously for dual-platform simulation, return consolidated results
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by per-item platform)
                ...
                - None: Interview each Agent on both platforms for dual-platform simulation
            timeout: Timeout in seconds
    ...
    def close_simulation_env(
        ...
        if not ipc_client.check_env_alive():
            return {
                "success": True,
                "message": "Environment is already shut down"
            }
        ...
        try:
            ...
            return {
                "success": True,
                "message": "Environment shutdown command sent (response timeout, environment may be shutting down)"
            }
