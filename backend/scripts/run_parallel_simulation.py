...
def _enrich_action_context(
    ...
    """
    Enrich actions with context information (post content, username, etc.)
...
async def run_twitter_simulation(
    ...
    # Get real Agent name mapping from config file (using entity_name instead of default Agent_X)
...
async def main():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Close the environment immediately after simulation completes, without entering command-waiting mode'
    )
