...
class ZepToolsService:
    ...
    def get_node_detail(self, node_uuid: str) -> Optional[NodeInfo]:
        ...
        try:
            node = self._call_with_retry(
                ...
                operation_name=f"get_node_details(uuid={node_uuid[:8]}...)"
            )
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all graph edges and filters those related to the specified node
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function, automatically decomposes queries and retrieves across multiple dimensions:
...
Return a JSON-formatted list of sub-queries."""
    ...
    def panorama_search(
        ...
        3. Categorizes current and historical information
    ...
    def interview_agents(
        ...
        Args:
            simulation_id: Simulation ID (for locating persona files and calling the interview API)
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean up JSON tool call wrappers in Agent responses and extract actual content"""
...
- Use quotation marks when quoting interviewee responses
